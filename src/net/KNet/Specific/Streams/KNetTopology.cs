...
namespace MASES.KNet.Streams
{
    ...
    public class KNetTopology : IGenericSerDesFactoryApplier
    {
        ...
        #region Constructors
        /// <inheritdoc/>
        public KNetTopology(IGenericSerDesFactory factory) : base() { _factory = factory; _topology = new Org.Apache.Kafka.Streams.Topology(); }
        /// <summary>
        ...
        internal KNetTopology(Org.Apache.Kafka.Streams.Topology topology, IGenericSerDesFactory factory)
        {
            _factory = factory;
            _topology = topology;
        }
        ...
        /// <summary>
        /// Converter from <see cref="KNetTopology"/> to <see cref="Org.Apache.Kafka.Streams.Topology"/>
        /// </summary>

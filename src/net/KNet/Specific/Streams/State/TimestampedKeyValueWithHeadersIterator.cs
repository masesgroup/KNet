...
namespace MASES.KNet.Streams.State
{
    ...
    public sealed class TimestampedKeyValueWithHeadersIterator<K, V, TJVMK, TJVMV> : CommonIterator<TimestampedKeyValueHeaders<K, V, TJVMK, TJVMV>>, IKNetInnerReference<Org.Apache.Kafka.Streams.State.KeyValueIterator<TJVMK, Org.Apache.Kafka.Streams.State.ValueTimestampHeaders<TJVMV>>>
    {
        ...
        sealed class PrefetchableLocalEnumerator(IGenericSerDesFactory factory,
            ...
            : JVMBridgeBasePrefetchableEnumerator<TimestampedKeyValueHeaders<K, V, TJVMK, TJVMV>>(obj, new PrefetchableEnumeratorSettings()),
              IGenericSerDesFactoryApplier,
              IAsyncEnumerator<TimestampedKeyValueHeaders<K, V, TJVMK, TJVMV>>
        {
            ...
            protected override object ConvertObject(object input)
            {
                ...
                {
                    return new TimestampedKeyValueHeaders<K, V, TJVMK, TJVMV>(_factory,
                                                                              JVMBridgeBase.WrapsDirect<Org.Apache.Kafka.Streams.KeyValue<TJVMK, Org.Apache.Kafka.Streams.State.ValueTimestampHeaders<TJVMV>>>(obj),
                                                                              keySerDes, true);
                }
            ...
            public TimestampedKeyValueHeaders<K, V, TJVMK, TJVMV> Current => (this as IEnumerator<TimestampedKeyValueHeaders<K, V, TJVMK, TJVMV>>).Current;
...
#endif
        sealed class StandardLocalEnumerator : JVMBridgeBaseEnumerator<TimestampedKeyValueHeaders<K, V, TJVMK, TJVMV>>, IGenericSerDesFactoryApplier, IAsyncEnumerator<TimestampedKeyValueHeaders<K, V, TJVMK, TJVMV>>
        {
        ...
        Org.Apache.Kafka.Streams.State.KeyValueIterator<TJVMK, Org.Apache.Kafka.Streams.State.ValueTimestampHeaders<TJVMV>> _iterator = null;
        ISerDes<K, TJVMK> _keySerDes;

        internal TimestampedKeyValueWithHeadersIterator(IGenericSerDesFactory factory, Org.Apache.Kafka.Streams.State.KeyValueIterator<TJVMK, Org.Apache.Kafka.Streams.State.ValueTimestampHeaders<TJVMV>> iterator)
            : base(factory)
        {
            _iterator = iterator;
        }
        ...
        /// <inheritdoc/>
        public Org.Apache.Kafka.Streams.State.KeyValueIterator<TJVMK, Org.Apache.Kafka.Streams.State.ValueTimestampHeaders<TJVMV>> InnerReference => _iterator;
        ...
        /// </summary>
        public TimestampedKeyValueHeaders<K, V, TJVMK, TJVMV> Next()
        {
            IGenericSerDesFactory factory = Factory;
            _keySerDes ??= factory?.BuildKeySerDes<K, TJVMK>();
            var kv = _iterator.Next();
            if (kv == null) return null;
            return new TimestampedKeyValueHeaders<K, V, TJVMK, TJVMV>(factory, kv, _keySerDes, false);
        }
        /// <summary>

...
namespace MASES.KNet.Streams.State
{
    ...
    public sealed class TimestampedKeyValueIterator<K, V, TJVMK, TJVMV> : CommonIterator<TimestampedKeyValue<K, V, TJVMK, TJVMV>>, IKNetInnerReference<Org.Apache.Kafka.Streams.State.KeyValueIterator<TJVMK, Org.Apache.Kafka.Streams.State.ValueAndTimestamp<TJVMV>>>
    {
        ...
        /// <inheritdoc/>
        public Org.Apache.Kafka.Streams.State.KeyValueIterator<TJVMK, Org.Apache.Kafka.Streams.State.ValueAndTimestamp<TJVMV>> InnerReference => _iterator;

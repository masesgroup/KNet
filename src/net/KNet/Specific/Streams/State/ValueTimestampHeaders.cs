...
namespace MASES.KNet.Streams.State
{
    ...
    public class ValueTimestampHeaders<V, TJVMV> : IKNetInnerReference<Org.Apache.Kafka.Streams.State.ValueTimestampHeaders<TJVMV>>, IGenericSerDesFactoryApplier, IDisposable
    {
        Org.Apache.Kafka.Streams.State.ValueTimestampHeaders<TJVMV> _inner;
        ISerDes<V, TJVMV> _valueSerDes;
        IGenericSerDesFactory _factory;
        IGenericSerDesFactory IGenericSerDesFactoryApplier.Factory { get => _factory; set => _factory = value; }

        internal ValueTimestampHeaders(IGenericSerDesFactory factory, Org.Apache.Kafka.Streams.State.ValueTimestampHeaders<TJVMV> valueAndTimestamp)
        {
            _factory = factory;
        ...
        /// <inheritdoc/>
        public Org.Apache.Kafka.Streams.State.ValueTimestampHeaders<TJVMV> InnerReference => _inner;
        ...
        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-streams/4.2.1/org/apache/kafka/streams/state/ValueAndTimestamp.html#timestamp()"/>
        /// </summary>
        ...
        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-streams/4.2.1/org/apache/kafka/streams/state/ValueAndTimestamp.html#value()"/>
        /// </summary>

...
namespace MASES.KNet.Streams.State
{
    ...
    public sealed class KeyValueIterator<K, V, TJVMK, TJVMV> : CommonIterator<KeyValue<K, V, TJVMK, TJVMV>>, IKNetInnerReference<Org.Apache.Kafka.Streams.State.KeyValueIterator<TJVMK, TJVMV>>
    {
        ...
        /// <inheritdoc/>
        public Org.Apache.Kafka.Streams.State.KeyValueIterator<TJVMK, TJVMV> InnerReference => _iterator;
        ...
        public KeyValue<K, V, TJVMK, TJVMV> Next()
        {
            ...
            return new KeyValue<K, V, TJVMK, TJVMV>(factory, kv, _keySerDes, _valueSerDes, false);
        }
        /// <summary>

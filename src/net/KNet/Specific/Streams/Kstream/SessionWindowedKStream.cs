...
namespace MASES.KNet.Streams.Kstream
{
    ...
    public class SessionWindowedKStream<K, V, TJVMK, TJVMV> : IGenericSerDesFactoryApplier, IDisposable
    {
        ...
        protected void CheckDisposed() { lock (_lock) { if (_disposed) throw new ObjectDisposedException(nameof(SessionWindowedKStream<K, V, TJVMK, TJVMV>)); } }

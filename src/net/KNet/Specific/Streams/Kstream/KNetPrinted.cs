...
namespace MASES.KNet.Streams.Kstream
{
    ...
    public class KNetPrinted<K, V, TJVMK, TJVMV> : IGenericSerDesFactoryApplier
    {
        readonly Org.Apache.Kafka.Streams.Kstream.Printed<TJVMK, TJVMV> _inner;
        IGenericSerDesFactory _factory;
        IGenericSerDesFactory IGenericSerDesFactoryApplier.Factory { get => _factory; set { _factory = value; } }

        protected KNetPrinted(Org.Apache.Kafka.Streams.Kstream.Printed<TJVMK, TJVMV> inner)
        {
            _inner = inner;
        }

        /// <summary>
        /// Converter from <see cref="KNetPrinted{K, V, TJVMK, TJVMV}"/> to <see cref="Org.Apache.Kafka.Streams.Kstream.Printed{TJVMK, TJVMV}"/>
        /// </summary>
        public static implicit operator Org.Apache.Kafka.Streams.Kstream.Printed<TJVMK, TJVMV>(KNetPrinted<K, V, TJVMK, TJVMV> t) => t._inner;
        ...
        /// <returns><see cref="KNetPrinted{K, V, TJVMK, TJVMV}"/></returns>
        public static KNetPrinted<K, V, TJVMK, TJVMV> ToFile(string arg0)
        {
            var cons = Org.Apache.Kafka.Streams.Kstream.Printed<TJVMK, TJVMV>.ToFile(arg0);
            return new KNetPrinted<K, V, TJVMK, TJVMV>(cons);
        }
        /// <summary>
        ...
        /// </summary>
        /// <returns><see cref="KNetPrinted{K, V, TJVMK, TJVMV}"/></returns>
        public static KNetPrinted<K, V, TJVMK, TJVMV> ToSysOut()
        {
        ...
        /// <returns><see cref="KNetPrinted{K, V, TJVMK, TJVMV}"/></returns>
        public KNetPrinted<K, V, TJVMK, TJVMV> WithKeyValueMapper<Arg0objectSuperK, Arg0objectSuperV>(KNetKeyValueMapper<Arg0objectSuperK, Arg0objectSuperV, string, TJVMK, TJVMV, Java.Lang.String> arg0) where Arg0objectSuperK : K where Arg0objectSuperV : V
        {
        ...
        /// <param name="arg0"><see cref="string"/></param>
        /// <returns><see cref="KNetPrinted{K, V, TJVMK, TJVMV}"/></returns>
        public KNetPrinted<K, V, TJVMK, TJVMV> WithLabel(string arg0)
        {
    ...
    /// <summary>
    /// KNet extension of <see cref="KNetPrinted{K, V, TJVMK, TJVMV}"/>
    /// </summary>
    /// <typeparam name="K"></typeparam>
    /// <typeparam name="V"></typeparam>
    public class KNetPrinted<K, V> : KNetPrinted<K, V, byte[], byte[]>
    {
        KNetPrinted(Org.Apache.Kafka.Streams.Kstream.Printed<byte[], byte[]> inner) : base(inner)
        {
        }
    }
}

...
namespace MASES.KNet.Streams.Kstream
{
    ...
    public class TimeWindowedKStream<K, V, TJVMK, TJVMV> : IGenericSerDesFactoryApplier, IDisposable
    {
        ...
        protected void CheckDisposed() { lock (_lock) { if (_disposed) throw new ObjectDisposedException(nameof(TimeWindowedKStream<K, V, TJVMK, TJVMV>)); } }

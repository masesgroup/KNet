...
namespace MASES.KNet.Streams.Processor.Api
{
    ...
    public abstract class Processor<KIn, VIn, KOut, VOut, TJVMKIn, TJVMVIn, TJVMKOut, TJVMVOut> : Org.Apache.Kafka.Streams.Processor.Api.Processor<TJVMKIn, TJVMVIn, TJVMKOut, TJVMVOut>, IGenericSerDesFactoryApplier
    {
        ...
        /// <summary>
        /// <see cref="ProcessorContext{KOut, VOut}"/> received from the init
        /// </summary>
        public abstract ProcessorContext<KOut, VOut> Context { get; }
        ...
        public new System.Action<Record<KIn, VIn>> OnProcess { get; set; } = null;
        ...
        /// </summary>
        /// <param name="arg0"><see cref="Record{KIn, VIn}"/></param>
        ...
        public new System.Action<ProcessorContext<KOut, VOut>> OnInit { get; set; } = null;
        ...
        /// </summary>
        /// <param name="arg0"><see cref="ProcessorContext{KOut, VOut}"/></param>
    ...
    {
        ProcessorContext<KOut, VOut> _processorContext = null;
        /// <inheritdoc/>
        public override ProcessorContext<KOut, VOut> Context => _processorContext;
        /// <summary>
        /// Handler for <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-streams/3.6.1/org/apache/kafka/streams/processor/api/Processor.html#process-org.apache.kafka.streams.processor.api.Record-"/>
        /// </summary>
        /// <remarks>If <see cref="OnProcess"/> has a value it takes precedence over corresponding class method</remarks>
        ...
        public sealed override void Process(Org.Apache.Kafka.Streams.Processor.Api.Record<byte[], byte[]> arg0)
        {
            ...
            methodToExecute(new Record<KIn, VIn>(Factory, arg0, Context.RecordMetadata));
        }
        ...
        {
            _processorContext = new ProcessorContext<KOut, VOut>(arg0);

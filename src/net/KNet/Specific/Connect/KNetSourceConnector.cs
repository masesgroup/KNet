...
namespace MASES.KNet.Connect
{
        ...
        where TTask : KNetSourceTask<TTask>
    {
        ...
        /// Similar to validate, this method may be called by the runtime before the <see cref="KNetConnector.Start(IKNetConfigurationFromMap)"/>> method is invoked.
        /// Do not store neither <paramref name="connectorConfig"/> nor <paramref name="offsets"/> for further reuse since their will be disposed when <see cref="AlterOffsets(Map{Java.Lang.String, Java.Lang.String}, Map{Map{Java.Lang.String, object}, Map{Java.Lang.String, object}})"/> returns.
        /// </remarks>

...
namespace MASES.KNet.Consumer
{
    ...
    public interface IConsumer<K, V, TJVMK, TJVMV> : Org.Apache.Kafka.Clients.Consumer.IConsumer<TJVMK, TJVMV>
    {
        ...
        /// </summary>
        /// <param name="timeoutMs">Timeout in milliseconds</param>
        /// <param name="callback">The <see cref="Func{T, TResult}"/> where receive <see cref="ConsumerRecord{K, V, TJVMK, TJVMV}"/>; return <see langword="true"/> from <paramref name="callback"/> to dispose the object</param>

...
namespace MASES.KNet.Common.Config
{
    public class TopicConfig : JCOBridge.C2JBridge.JVMBridgeBase<TopicConfig>
    {
        ...
        public override string BridgeClassName => "org.apache.kafka.common.config.TopicConfig";

        public static readonly string SEGMENT_BYTES_CONFIG = BridgeClazz.GetField<string>("SEGMENT_BYTES_CONFIG");

        public static readonly string SEGMENT_MS_CONFIG = BridgeClazz.GetField<string>("SEGMENT_MS_CONFIG");

        public static readonly string SEGMENT_JITTER_MS_CONFIG = BridgeClazz.GetField<string>("SEGMENT_JITTER_MS_CONFIG");

        public static readonly string SEGMENT_INDEX_BYTES_CONFIG = BridgeClazz.GetField<string>("SEGMENT_INDEX_BYTES_CONFIG");

        public static readonly string FLUSH_MESSAGES_INTERVAL_CONFIG = BridgeClazz.GetField<string>("FLUSH_MESSAGES_INTERVAL_CONFIG");

        public static readonly string FLUSH_MS_CONFIG = BridgeClazz.GetField<string>("FLUSH_MS_CONFIG");

        public static readonly string RETENTION_BYTES_CONFIG = BridgeClazz.GetField<string>("RETENTION_BYTES_CONFIG");

        public static readonly string RETENTION_MS_CONFIG = BridgeClazz.GetField<string>("RETENTION_MS_CONFIG");

        public static readonly string REMOTE_LOG_STORAGE_ENABLE_CONFIG = BridgeClazz.GetField<string>("REMOTE_LOG_STORAGE_ENABLE_CONFIG");

        public static readonly string LOCAL_LOG_RETENTION_MS_CONFIG = BridgeClazz.GetField<string>("LOCAL_LOG_RETENTION_MS_CONFIG");

        public static readonly string LOCAL_LOG_RETENTION_BYTES_CONFIG = BridgeClazz.GetField<string>("LOCAL_LOG_RETENTION_BYTES_CONFIG");

        public static readonly string MAX_MESSAGE_BYTES_CONFIG = BridgeClazz.GetField<string>("MAX_MESSAGE_BYTES_CONFIG");

        public static readonly string INDEX_INTERVAL_BYTES_CONFIG = BridgeClazz.GetField<string>("INDEX_INTERVAL_BYTES_CONFIG");

        public static readonly string FILE_DELETE_DELAY_MS_CONFIG = BridgeClazz.GetField<string>("FILE_DELETE_DELAY_MS_CONFIG");

        public static readonly string DELETE_RETENTION_MS_CONFIG = BridgeClazz.GetField<string>("DELETE_RETENTION_MS_CONFIG");

        public static readonly string MIN_COMPACTION_LAG_MS_CONFIG = BridgeClazz.GetField<string>("MIN_COMPACTION_LAG_MS_CONFIG");

        public static readonly string MAX_COMPACTION_LAG_MS_CONFIG = BridgeClazz.GetField<string>("MAX_COMPACTION_LAG_MS_CONFIG");

        public static readonly string MIN_CLEANABLE_DIRTY_RATIO_CONFIG = BridgeClazz.GetField<string>("MIN_CLEANABLE_DIRTY_RATIO_CONFIG");
        [System.Flags]
        ...
        public static readonly string CLEANUP_POLICY_CONFIG = BridgeClazz.GetField<string>("CLEANUP_POLICY_CONFIG");
        public static readonly string CLEANUP_POLICY_COMPACT = BridgeClazz.GetField<string>("CLEANUP_POLICY_COMPACT");
        public static readonly string CLEANUP_POLICY_DELETE = BridgeClazz.GetField<string>("CLEANUP_POLICY_DELETE");

        public static readonly string UNCLEAN_LEADER_ELECTION_ENABLE_CONFIG = BridgeClazz.GetField<string>("UNCLEAN_LEADER_ELECTION_ENABLE_CONFIG");

        public static readonly string MIN_IN_SYNC_REPLICAS_CONFIG = BridgeClazz.GetField<string>("MIN_IN_SYNC_REPLICAS_CONFIG");
        ...
        public static readonly string PREALLOCATE_CONFIG = BridgeClazz.GetField<string>("PREALLOCATE_CONFIG");

        [System.Obsolete()]
        public static readonly string MESSAGE_FORMAT_VERSION_CONFIG = BridgeClazz.GetField<string>("MESSAGE_FORMAT_VERSION_CONFIG");
        ...
        public static readonly string MESSAGE_TIMESTAMP_TYPE_CONFIG = BridgeClazz.GetField<string>("MESSAGE_TIMESTAMP_TYPE_CONFIG");

        public static readonly string MESSAGE_TIMESTAMP_DIFFERENCE_MAX_MS_CONFIG = BridgeClazz.GetField<string>("MESSAGE_TIMESTAMP_DIFFERENCE_MAX_MS_CONFIG");

        public static readonly string MESSAGE_DOWNCONVERSION_ENABLE_CONFIG = BridgeClazz.GetField<string>("MESSAGE_DOWNCONVERSION_ENABLE_CONFIG");

...
{
    public class DescribeProducersResult : MASES.JCOBridge.C2JBridge.JVMBridgeBase<DescribeProducersResult>
    {
        ...
        public class PartitionProducerState : MASES.JCOBridge.C2JBridge.JVMBridgeBase<DescribeProducersResult>
        {

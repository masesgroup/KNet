...
{
    public class UserScramCredentialsDescription : MASES.JCOBridge.C2JBridge.JVMBridgeBase<UserScramCredentialsDescription>
    {
        ...
        public UserScramCredentialsDescription(string name, List<ScramCredentialInfo> credentialInfos)
            :base(name, credentialInfos)
        {
        }

        public string Name => IExecute<string>("name");

        public List<ScramCredentialInfo> CredentialInfos => IExecute<List<ScramCredentialInfo>>("credentialInfos");
    }
}

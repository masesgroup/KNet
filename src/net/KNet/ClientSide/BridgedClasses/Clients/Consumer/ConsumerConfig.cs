...
namespace MASES.KNet.Clients.Consumer
{
    public class ConsumerConfig : AbstractConfig<ConsumerConfig>
    {
        ...
        public static readonly string GROUP_ID_CONFIG = BridgeClazz.GetField<string>("GROUP_ID_CONFIG");

        public static readonly string GROUP_INSTANCE_ID_CONFIG = BridgeClazz.GetField<string>("GROUP_INSTANCE_ID_CONFIG");

        public static readonly string MAX_POLL_RECORDS_CONFIG = BridgeClazz.GetField<string>("MAX_POLL_RECORDS_CONFIG");

        public static readonly string MAX_POLL_INTERVAL_MS_CONFIG = BridgeClazz.GetField<string>("MAX_POLL_INTERVAL_MS_CONFIG");

        public static readonly string SESSION_TIMEOUT_MS_CONFIG = BridgeClazz.GetField<string>("SESSION_TIMEOUT_MS_CONFIG");

        public static readonly string HEARTBEAT_INTERVAL_MS_CONFIG = BridgeClazz.GetField<string>("HEARTBEAT_INTERVAL_MS_CONFIG");
        ...
        public static readonly string ENABLE_AUTO_COMMIT_CONFIG = BridgeClazz.GetField<string>("ENABLE_AUTO_COMMIT_CONFIG");

        public static readonly string AUTO_COMMIT_INTERVAL_MS_CONFIG = BridgeClazz.GetField<string>("AUTO_COMMIT_INTERVAL_MS_CONFIG");

        public static readonly string PARTITION_ASSIGNMENT_STRATEGY_CONFIG = BridgeClazz.GetField<string>("PARTITION_ASSIGNMENT_STRATEGY_CONFIG");

        public static readonly string AUTO_OFFSET_RESET_CONFIG = BridgeClazz.GetField<string>("AUTO_OFFSET_RESET_CONFIG");

        public static readonly string FETCH_MIN_BYTES_CONFIG = BridgeClazz.GetField<string>("FETCH_MIN_BYTES_CONFIG");

        public static readonly string FETCH_MAX_BYTES_CONFIG = BridgeClazz.GetField<string>("FETCH_MAX_BYTES_CONFIG");

        public static readonly int DEFAULT_FETCH_MAX_BYTES = BridgeClazz.GetField<int>("DEFAULT_FETCH_MAX_BYTES");

        public static readonly string FETCH_MAX_WAIT_MS_CONFIG = BridgeClazz.GetField<string>("FETCH_MAX_WAIT_MS_CONFIG");

        public static readonly string METADATA_MAX_AGE_CONFIG = BridgeClazz.GetField<string>("METADATA_MAX_AGE_CONFIG");

        public static readonly string MAX_PARTITION_FETCH_BYTES_CONFIG = BridgeClazz.GetField<string>("MAX_PARTITION_FETCH_BYTES_CONFIG");

        public static readonly int DEFAULT_MAX_PARTITION_FETCH_BYTES = BridgeClazz.GetField<int>("DEFAULT_MAX_PARTITION_FETCH_BYTES");
        ...
        public static readonly string CLIENT_RACK_CONFIG = BridgeClazz.GetField<string>("CLIENT_RACK_CONFIG");
        ...
        public static readonly string CHECK_CRCS_CONFIG = BridgeClazz.GetField<string>("CHECK_CRCS_CONFIG");

        public static readonly string KEY_DESERIALIZER_CLASS_CONFIG = BridgeClazz.GetField<string>("KEY_DESERIALIZER_CLASS_CONFIG");

        public static readonly string VALUE_DESERIALIZER_CLASS_CONFIG = BridgeClazz.GetField<string>("VALUE_DESERIALIZER_CLASS_CONFIG");
        ...
        public static readonly string DEFAULT_API_TIMEOUT_MS_CONFIG = BridgeClazz.GetField<string>("DEFAULT_API_TIMEOUT_MS_CONFIG");

        public static readonly string INTERCEPTOR_CLASSES_CONFIG = BridgeClazz.GetField<string>("INTERCEPTOR_CLASSES_CONFIG");

        public static readonly string EXCLUDE_INTERNAL_TOPICS_CONFIG = BridgeClazz.GetField<string>("EXCLUDE_INTERNAL_TOPICS_CONFIG");

        public static readonly bool DEFAULT_EXCLUDE_INTERNAL_TOPICS = BridgeClazz.GetField<bool>("DEFAULT_EXCLUDE_INTERNAL_TOPICS");

        public static readonly string ISOLATION_LEVEL_CONFIG = BridgeClazz.GetField<string>("ISOLATION_LEVEL_CONFIG");

        public static readonly string DEFAULT_ISOLATION_LEVEL = BridgeClazz.GetField<string>("DEFAULT_ISOLATION_LEVEL");

        public static readonly string ALLOW_AUTO_CREATE_TOPICS_CONFIG = BridgeClazz.GetField<string>("ALLOW_AUTO_CREATE_TOPICS_CONFIG");

        public static readonly bool DEFAULT_ALLOW_AUTO_CREATE_TOPICS = BridgeClazz.GetField<bool>("DEFAULT_ALLOW_AUTO_CREATE_TOPICS");

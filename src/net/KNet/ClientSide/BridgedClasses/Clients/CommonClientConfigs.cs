...
namespace MASES.KNet.Clients
{
    public class CommonClientConfigs : JCOBridge.C2JBridge.JVMBridgeBase<CommonClientConfigs>
    {
        ...
        public static readonly string DEFAULT_LIST_KEY_SERDE_INNER_CLASS = BridgeClazz.GetField<string>("DEFAULT_LIST_KEY_SERDE_INNER_CLASS");

        public static readonly string DEFAULT_LIST_VALUE_SERDE_INNER_CLASS = BridgeClazz.GetField<string>("DEFAULT_LIST_VALUE_SERDE_INNER_CLASS");

        public static readonly string DEFAULT_LIST_KEY_SERDE_TYPE_CLASS = BridgeClazz.GetField<string>("DEFAULT_LIST_KEY_SERDE_TYPE_CLASS");

        public static readonly string DEFAULT_LIST_VALUE_SERDE_TYPE_CLASS = BridgeClazz.GetField<string>("DEFAULT_LIST_VALUE_SERDE_TYPE_CLASS");
        ...
        public static readonly string REBALANCE_TIMEOUT_MS_CONFIG = BridgeClazz.GetField<string>("REBALANCE_TIMEOUT_MS_CONFIG");

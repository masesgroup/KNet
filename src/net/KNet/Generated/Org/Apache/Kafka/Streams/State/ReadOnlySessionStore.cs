...
namespace Org.Apache.Kafka.Streams.State
{
    ...
    /// </summary>
    public partial class ReadOnlySessionStore : MASES.JCOBridge.C2JBridge.JVMBridgeCore<ReadOnlySessionStore>
    {
    ...
    public partial class ReadOnlySessionStore<K, AGG> : MASES.JCOBridge.C2JBridge.JVMBridgeCore<ReadOnlySessionStore<K, AGG>>
    {
        const string _bridgeClassName = "org.apache.kafka.streams.state.ReadOnlySessionStore";
        /// <summary>
        /// Internal constructor: used internally from JCOBridge

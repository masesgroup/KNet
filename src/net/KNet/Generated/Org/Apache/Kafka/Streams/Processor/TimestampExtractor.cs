...
namespace Org.Apache.Kafka.Streams.Processor
{
    ...
    /// <summary>
    /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-streams/3.9.2/org/apache/kafka/streams/processor/TimestampExtractor.html"/>
    /// </summary>
    public partial class TimestampExtractor : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        public TimestampExtractor(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasTimestampExtractorSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasTimestampExtractorSecondGate;
        ...
        /// <item><see cref="_hasTimestampExtractorSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasTimestampExtractorSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="TimestampExtractor"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="TimestampExtractor"/> instead.</para>
    /// </remarks>
    public partial class TimestampExtractorDirect : TimestampExtractor
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public TimestampExtractorDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public TimestampExtractorDirect(params object[] args) : base(args) { }
    ...
    /// <summary>
    /// .NET interface for org.mases.knet.generated.org.apache.kafka.streams.processor.TimestampExtractor implementing <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-streams/3.9.2/org/apache/kafka/streams/processor/TimestampExtractor.html"/>
    /// </summary>
    ...
    public partial class TimestampExtractor : Org.Apache.Kafka.Streams.Processor.ITimestampExtractor
    {
        ...
        {
            _ExtractEventHandlerIndex = AddEventHandler("extract", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(ExtractEventHandler));
            _hasOverrideExtract = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(Extract), typeof(Org.Apache.Kafka.Clients.Consumer.ConsumerRecord<object, object>), typeof(long));
        ...
        public global::System.Action<long> OnExtractDispose { get; set; } = null;
        ...
        void ExtractEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            data.EventData.SetReturnData(ExtractEventOverridden(), executionResult);
            OnExtractDispose?.Invoke(executionResult);
        }

        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-streams/3.9.2/org/apache/kafka/streams/processor/TimestampExtractor.html#extract-org.apache.kafka.clients.consumer.ConsumerRecord-long-"/>
        /// </summary>

...
namespace Org.Apache.Kafka.Streams.Kstream
{
    ...
    /// <summary>
    /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-streams/3.9.2/org/apache/kafka/streams/kstream/ForeachAction.html"/>
    /// </summary>
    public partial class ForeachAction : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public ForeachAction(IJVMBridgeBaseInitializer initializer) : base(initializer) { }
        ...
        public ForeachAction(params object[] args) : base(args)
        {
            ...
            _hasForeachActionSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasForeachActionSecondGate;
        ...
        /// <item><see cref="_hasForeachActionSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasForeachActionSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="ForeachAction"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="ForeachAction"/> instead.</para>
    /// </remarks>
    public partial class ForeachActionDirect : ForeachAction
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public ForeachActionDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public ForeachActionDirect(params object[] args) : base(args) { }
    ...
    public partial class ForeachAction
    {
        ...
        void ApplyEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            ...
            data.EventData.HasOverride = ApplyEventOverridden();
        }

        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-streams/3.9.2/org/apache/kafka/streams/kstream/ForeachAction.html#apply-java.lang.Object-java.lang.Object-"/>
        /// </summary>
    ...
    /// <summary>
    /// .NET interface for org.mases.knet.generated.org.apache.kafka.streams.kstream.ForeachAction implementing <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-streams/3.9.2/org/apache/kafka/streams/kstream/ForeachAction.html"/>
    /// </summary>

...
namespace Org.Apache.Kafka.Streams.State
{
    ...
    /// </summary>
    public partial class KeyValueStore : MASES.JCOBridge.C2JBridge.JVMBridgeCore<KeyValueStore>
    {
    ...
    public partial class KeyValueStore<K, V> : MASES.JCOBridge.C2JBridge.JVMBridgeCore<KeyValueStore<K, V>>
    {
        const string _bridgeClassName = "org.apache.kafka.streams.state.KeyValueStore";
        /// <summary>
        /// Internal constructor: used internally from JCOBridge

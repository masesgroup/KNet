...
namespace Org.Apache.Kafka.Streams.Processor
{
    ...
    /// <summary>
    /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-streams/3.9.2/org/apache/kafka/streams/processor/StateRestoreCallback.html"/>
    /// </summary>
    public partial class StateRestoreCallback : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public StateRestoreCallback(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public StateRestoreCallback(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasStateRestoreCallbackSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasStateRestoreCallbackSecondGate;
        ...
        /// <item><see cref="_hasStateRestoreCallbackSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasStateRestoreCallbackSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="StateRestoreCallback"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="StateRestoreCallback"/> instead.</para>
    /// </remarks>
    public partial class StateRestoreCallbackDirect : StateRestoreCallback
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public StateRestoreCallbackDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public StateRestoreCallbackDirect(params object[] args) : base(args) { }
    ...
    /// <summary>
    /// .NET interface for org.mases.knet.generated.org.apache.kafka.streams.processor.StateRestoreCallback implementing <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-streams/3.9.2/org/apache/kafka/streams/processor/StateRestoreCallback.html"/>
    /// </summary>
    ...
    public partial class StateRestoreCallback : Org.Apache.Kafka.Streams.Processor.IStateRestoreCallback
    {
        ...
        /// <summary>
        /// Handler for <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-streams/3.9.2/org/apache/kafka/streams/processor/StateRestoreCallback.html#restore-byte[]-byte[]-"/>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-streams/3.9.2/org/apache/kafka/streams/processor/StateRestoreCallback.html#restore-byte[]-byte[]-"/>
        /// </summary>

...
namespace Org.Apache.Kafka.Streams.Processor.Api
{
    ...
    public partial class FixedKeyProcessor
    {
        ...
        {
            _ProcessEventHandlerIndex = AddEventHandler("process", new global::System.EventHandler<CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>>>(ProcessEventHandler));
        ...
        void ProcessEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.EventData.TypedEventData.HasOverride = ProcessEventOverridden();
        }

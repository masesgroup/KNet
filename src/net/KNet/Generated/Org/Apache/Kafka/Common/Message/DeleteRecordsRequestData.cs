...
namespace Org.Apache.Kafka.Common.Message
{
    ...
    public partial class DeleteRecordsRequestData
    {
        ...
        {
            return IExecute<Java.Util.List<Org.Apache.Kafka.Common.Message.DeleteRecordsRequestData.DeleteRecordsTopic>>("topics");
        }
        /// <summary>
        ...
        public partial class DeleteRecordsTopic
        {
            ...
            {
                return IExecute<Java.Util.List<Org.Apache.Kafka.Common.Message.DeleteRecordsRequestData.DeleteRecordsPartition>>("partitions");
            }
            /// <summary>

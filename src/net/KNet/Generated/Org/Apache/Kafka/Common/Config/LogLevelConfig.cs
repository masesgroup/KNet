...
namespace Org.Apache.Kafka.Common.Config
{
    ...
    public partial class LogLevelConfig
    {
        ...
        /// </summary>
        public static string DEBUG_LOG_LEVEL { get { if (!_DEBUG_LOG_LEVELReady) { _DEBUG_LOG_LEVELContent = SGetField<string>(LocalBridgeClazz, "DEBUG_LOG_LEVEL"); _DEBUG_LOG_LEVELReady = true; } return _DEBUG_LOG_LEVELContent; } }
        private static string _DEBUG_LOG_LEVELContent = default;
        ...
        /// </summary>
        public static string ERROR_LOG_LEVEL { get { if (!_ERROR_LOG_LEVELReady) { _ERROR_LOG_LEVELContent = SGetField<string>(LocalBridgeClazz, "ERROR_LOG_LEVEL"); _ERROR_LOG_LEVELReady = true; } return _ERROR_LOG_LEVELContent; } }
        private static string _ERROR_LOG_LEVELContent = default;
        ...
        /// </summary>
        public static string FATAL_LOG_LEVEL { get { if (!_FATAL_LOG_LEVELReady) { _FATAL_LOG_LEVELContent = SGetField<string>(LocalBridgeClazz, "FATAL_LOG_LEVEL"); _FATAL_LOG_LEVELReady = true; } return _FATAL_LOG_LEVELContent; } }
        private static string _FATAL_LOG_LEVELContent = default;
        ...
        /// </summary>
        public static string INFO_LOG_LEVEL { get { if (!_INFO_LOG_LEVELReady) { _INFO_LOG_LEVELContent = SGetField<string>(LocalBridgeClazz, "INFO_LOG_LEVEL"); _INFO_LOG_LEVELReady = true; } return _INFO_LOG_LEVELContent; } }
        private static string _INFO_LOG_LEVELContent = default;
        ...
        /// </summary>
        public static string TRACE_LOG_LEVEL { get { if (!_TRACE_LOG_LEVELReady) { _TRACE_LOG_LEVELContent = SGetField<string>(LocalBridgeClazz, "TRACE_LOG_LEVEL"); _TRACE_LOG_LEVELReady = true; } return _TRACE_LOG_LEVELContent; } }
        private static string _TRACE_LOG_LEVELContent = default;
        ...
        /// </summary>
        public static string WARN_LOG_LEVEL { get { if (!_WARN_LOG_LEVELReady) { _WARN_LOG_LEVELContent = SGetField<string>(LocalBridgeClazz, "WARN_LOG_LEVEL"); _WARN_LOG_LEVELReady = true; } return _WARN_LOG_LEVELContent; } }
        private static string _WARN_LOG_LEVELContent = default;

...
namespace Org.Apache.Kafka.Common.Security.Scram
{
    ...
    public partial class ScramCredential
    {
        #region Constructors
        /// <summary>
        /// <see href="https://www.javadoc.io/static/org.apache.kafka/kafka-clients/3.4.0/org/apache/kafka/common/security/scram/ScramCredential.html#%3Cinit%3E(byte[],byte[],byte[],int)"/>
        /// </summary>

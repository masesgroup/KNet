...
namespace Org.Apache.Kafka.Common.Security.Scram
{
    ...
    public partial class ScramLoginModule
    {
        ...
        /// </summary>
        public static string TOKEN_AUTH_CONFIG { get { if (!_TOKEN_AUTH_CONFIGReady) { _TOKEN_AUTH_CONFIGContent = SGetField<string>(LocalBridgeClazz, "TOKEN_AUTH_CONFIG"); _TOKEN_AUTH_CONFIGReady = true; } return _TOKEN_AUTH_CONFIGContent; } }
        private static string _TOKEN_AUTH_CONFIGContent = default;

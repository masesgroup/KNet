...
namespace Org.Apache.Kafka.Common
{
    ...
    public partial class Cluster
    {
        ...
        {
            return IExecute<Java.Lang.String>("topicName", arg0);
        }
        /// <summary>
        ...
        {
            return IExecute<Java.Util.Set<Java.Lang.String>>("internalTopics");
        }
        /// <summary>
        ...
        {
            return IExecute<Java.Util.Set<Java.Lang.String>>("invalidTopics");
        }
        /// <summary>
        ...
        {
            return IExecute<Java.Util.Set<Java.Lang.String>>("topics");
        }
        /// <summary>
        ...
        {
            return IExecute<Java.Util.Set<Java.Lang.String>>("unauthorizedTopics");
        }
        /// <summary>

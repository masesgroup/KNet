...
namespace Org.Apache.Kafka.Common.Config
{
    ...
    public partial class SecurityConfig
    {
        ...
        /// </summary>
        public static string SECURITY_PROVIDERS_DOC { get { if (!_SECURITY_PROVIDERS_DOCReady) { _SECURITY_PROVIDERS_DOCContent = SGetField<string>(LocalBridgeClazz, "SECURITY_PROVIDERS_DOC"); _SECURITY_PROVIDERS_DOCReady = true; } return _SECURITY_PROVIDERS_DOCContent; } }
        private static string _SECURITY_PROVIDERS_DOCContent = default;

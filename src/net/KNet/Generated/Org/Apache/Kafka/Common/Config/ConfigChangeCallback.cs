...
namespace Org.Apache.Kafka.Common.Config
{
    ...
    public partial class ConfigChangeCallback : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("ConfigChangeCallback class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]
        public ConfigChangeCallback(params object[] args) { }

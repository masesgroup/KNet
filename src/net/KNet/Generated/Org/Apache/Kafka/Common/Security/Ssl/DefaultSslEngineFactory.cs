...
namespace Org.Apache.Kafka.Common.Security.Ssl
{
    ...
    public partial class DefaultSslEngineFactory
    {
        ...
        /// </summary>
        public static string PEM_TYPE { get { if (!_PEM_TYPEReady) { _PEM_TYPEContent = SGetField<string>(LocalBridgeClazz, "PEM_TYPE"); _PEM_TYPEReady = true; } return _PEM_TYPEContent; } }
        private static string _PEM_TYPEContent = default;

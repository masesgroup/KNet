...
namespace Org.Apache.Kafka.Common.Compress
{
    ...
    public partial class KafkaLZ4BlockInputStream
    {
        ...
        /// </summary>
        public static string BLOCK_HASH_MISMATCH { get { if (!_BLOCK_HASH_MISMATCHReady) { _BLOCK_HASH_MISMATCHContent = SGetField<string>(LocalBridgeClazz, "BLOCK_HASH_MISMATCH"); _BLOCK_HASH_MISMATCHReady = true; } return _BLOCK_HASH_MISMATCHContent; } }
        private static string _BLOCK_HASH_MISMATCHContent = default;
        ...
        /// </summary>
        public static string DESCRIPTOR_HASH_MISMATCH { get { if (!_DESCRIPTOR_HASH_MISMATCHReady) { _DESCRIPTOR_HASH_MISMATCHContent = SGetField<string>(LocalBridgeClazz, "DESCRIPTOR_HASH_MISMATCH"); _DESCRIPTOR_HASH_MISMATCHReady = true; } return _DESCRIPTOR_HASH_MISMATCHContent; } }
        private static string _DESCRIPTOR_HASH_MISMATCHContent = default;
        ...
        /// </summary>
        public static string NOT_SUPPORTED { get { if (!_NOT_SUPPORTEDReady) { _NOT_SUPPORTEDContent = SGetField<string>(LocalBridgeClazz, "NOT_SUPPORTED"); _NOT_SUPPORTEDReady = true; } return _NOT_SUPPORTEDContent; } }
        private static string _NOT_SUPPORTEDContent = default;
        ...
        /// </summary>
        public static string PREMATURE_EOS { get { if (!_PREMATURE_EOSReady) { _PREMATURE_EOSContent = SGetField<string>(LocalBridgeClazz, "PREMATURE_EOS"); _PREMATURE_EOSReady = true; } return _PREMATURE_EOSContent; } }
        private static string _PREMATURE_EOSContent = default;

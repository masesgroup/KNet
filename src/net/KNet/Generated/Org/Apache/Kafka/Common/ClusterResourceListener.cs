...
namespace Org.Apache.Kafka.Common
{
    ...
    /// <summary>
    /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-clients/3.9.2/org/apache/kafka/common/ClusterResourceListener.html"/>
    /// </summary>
    public partial class ClusterResourceListener : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public ClusterResourceListener(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public ClusterResourceListener(params object[] args) : base(args)
        {
            var listenerRuntimeType = GetType();
            _hasClusterResourceListenerSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasClusterResourceListenerSecondGate;
        ...
        /// <item><see cref="_hasClusterResourceListenerSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasClusterResourceListenerSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="ClusterResourceListener"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="ClusterResourceListener"/> instead.</para>
    /// </remarks>
    public partial class ClusterResourceListenerDirect : ClusterResourceListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("This public initializer is needed for JCOBridge internal use, other uses can produce unidentifiable behaviors.")]
        public ClusterResourceListenerDirect(IJVMBridgeBaseInitializer initializer) : base(initializer) { }

        /// <summary>
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public ClusterResourceListenerDirect(params object[] args) : base(args) { }
    ...
    /// <summary>
    /// .NET interface for org.mases.knet.generated.org.apache.kafka.common.ClusterResourceListener implementing <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-clients/3.9.2/org/apache/kafka/common/ClusterResourceListener.html"/>
    /// </summary>
    ...
    public partial class ClusterResourceListener : Org.Apache.Kafka.Common.IClusterResourceListener
    {
        ...
        {
            _OnUpdateEventHandlerIndex = AddEventHandler("onUpdate", new global::System.EventHandler<CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData>>(OnUpdateEventHandler));
            _hasOverrideOnUpdate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnUpdate), typeof(Org.Apache.Kafka.Common.ClusterResource));

        }
        /// <inheritdoc/>
        protected virtual bool ListenerShallManageEventHandlers(int eventIndex)
        {
            if (eventIndex == _OnUpdateEventHandlerIndex) return OnUpdateEventOverridden();

            return false; // no one can manage event, continues to caller
        }

        /// <summary>
        /// Handler for <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-clients/3.9.2/org/apache/kafka/common/ClusterResourceListener.html#onUpdate-org.apache.kafka.common.ClusterResource-"/>
        /// </summary>
        /// <remarks>
        ...
        /// <summary>Index assigned by <see cref="AddEventHandler"/> for the <see cref="OnUpdate"/> event. Used for zero-cost index-based filtering in <see cref="ListenerShallManageEvent(int)"/>.</summary>
        int _OnUpdateEventHandlerIndex = 0;

        /// <summary><see langword="true"/> if the user has overridden <see cref="OnUpdate"/> in a subclass. Cached at construction to avoid per-event reflection.</summary>
        bool _hasOverrideOnUpdate;
        ...
        bool OnUpdateEventOverridden() => _hasOverrideOnUpdate || OnOnUpdate != null;

        void OnUpdateEventHandler(object sender, CLRListenerEventArgs<MASES.JNet.Specific.JNetEventData> data)
        {
            if (!OnUpdateEventOverridden()) // guard: no handler registered — return without reading data.
            ...
            data.EventData.HasOverride = OnUpdateEventOverridden();
        }

        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-clients/3.9.2/org/apache/kafka/common/ClusterResourceListener.html#onUpdate-org.apache.kafka.common.ClusterResource-"/>
        /// </summary>

...
namespace Org.Apache.Kafka.Tools
{
    ...
    public partial class ConnectPluginPath
    {
        ...
        /// </summary>
        public static string NO_ALIAS { get { if (!_NO_ALIASReady) { _NO_ALIASContent = SGetField<string>(LocalBridgeClazz, "NO_ALIAS"); _NO_ALIASReady = true; } return _NO_ALIASContent; } }
        private static string _NO_ALIASContent = default;

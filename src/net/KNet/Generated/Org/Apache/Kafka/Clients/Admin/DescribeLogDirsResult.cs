...
namespace Org.Apache.Kafka.Clients.Admin
{
    ...
    public partial class DescribeLogDirsResult
    {
        ...
        {
            return IExecute<Java.Util.Map<Java.Lang.Integer, Org.Apache.Kafka.Common.KafkaFuture<Java.Util.Map<Java.Lang.String, Org.Apache.Kafka.Clients.Admin.LogDirDescription>>>>("descriptions");
        }
        /// <summary>
        ...
        {
            return IExecute<Org.Apache.Kafka.Common.KafkaFuture<Java.Util.Map<Java.Lang.Integer, Java.Util.Map<Java.Lang.String, Org.Apache.Kafka.Clients.Admin.LogDirDescription>>>>("allDescriptions");
        }

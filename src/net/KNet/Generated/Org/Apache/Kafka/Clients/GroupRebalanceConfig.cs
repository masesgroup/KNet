...
namespace Org.Apache.Kafka.Clients
{
    ...
    public partial class GroupRebalanceConfig
    {
        ...
        /// </summary>
        public Java.Util.Optional rackId { get { if (!_rackIdReady) { _rackIdContent = IGetField<Java.Util.Optional>("rackId"); _rackIdReady = true; } return _rackIdContent; } }
        private Java.Util.Optional _rackIdContent = default;
        private bool _rackIdReady = false; // this is used because in case of generics 
        /// <summary>

...
namespace Org.Apache.Kafka.Clients.Producer
{
    ...
    public partial class ProducerInterceptor : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        /// </summary>
        [global::System.Obsolete("ProducerInterceptor class represents, in .NET, an instance of a JVM interface or abstract class. This public initializer is needed for JCOBridge internal use, other uses can produce unidentible behaviors.")]

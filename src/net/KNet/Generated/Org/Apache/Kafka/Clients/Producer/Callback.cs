...
namespace Org.Apache.Kafka.Clients.Producer
{
    ...
    /// <summary>
    /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-clients/3.9.2/org/apache/kafka/clients/producer/Callback.html"/>
    /// </summary>
    public partial class Callback : MASES.JCOBridge.C2JBridge.JVMBridgeListener
    {
        ...
        public Callback(params object[] args) : base(args)
        {
            ...
            _hasCallbackSecondGate = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(ListenerShallManageEvent), typeof(int), typeof(object));
        ...
        /// </summary>
        readonly bool _hasCallbackSecondGate;
        ...
        /// <item><see cref="_hasCallbackSecondGate"/> — returns <see langword="true"/> if the second gate is overridden, ensuring all events reach it.</item>
        ...
        protected override bool ListenerShallManageEvent(int eventIndex)
        {
            ...
            return _hasCallbackSecondGate || ListenerShallManageEventIndexWithData != null || ListenerShallManageEventNameWithData != null;
        }
    ...
    /// <summary>
    /// Concrete CLR representation of <see cref="Callback"/> returned by the JVM.
    /// </summary>
    /// <remarks>
    ...
    /// <para>Do not use this class directly to register event handlers — use <see cref="Callback"/> instead.</para>
    /// </remarks>
    public partial class CallbackDirect : Callback
    {
        ...
        /// Generic constructor used by JCOBridge when a derived class needs to forward arguments to the base JVMBridgeBase class.
        /// </summary>
        public CallbackDirect(params object[] args) : base(args) { }
    ...
    #region ICallback
    /// <summary>
    /// .NET interface for org.mases.knet.generated.org.apache.kafka.clients.producer.Callback implementing <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-clients/3.9.2/org/apache/kafka/clients/producer/Callback.html"/>
    /// </summary>
    ...
    public partial class Callback : Org.Apache.Kafka.Clients.Producer.ICallback
    {
        ...
        {
            _OnCompletionEventHandlerIndex = AddEventHandler("onCompletion", new global::System.EventHandler<CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>>>(OnCompletionEventHandler));
            _hasOverrideOnCompletion = MASES.JNet.Specific.JNetEventResult.GetMethodIsOverridden(listenerRuntimeType, nameof(OnCompletion), typeof(Org.Apache.Kafka.Clients.Producer.RecordMetadata), typeof(MASES.JCOBridge.C2JBridge.JVMBridgeException));
        ...
        /// <summary>
        /// Handler for <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-clients/3.9.2/org/apache/kafka/clients/producer/Callback.html#onCompletion-org.apache.kafka.clients.producer.RecordMetadata-java.lang.Exception-"/>
        /// </summary>
        /// <remarks>
        ...
        void OnCompletionEventHandler(object sender, CLRListenerEventArgs<CLREventData<MASES.JNet.Specific.JNetEventResult>> data)
        {
            ...
            data.EventData.TypedEventData.HasOverride = OnCompletionEventOverridden();
        }

        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-clients/3.9.2/org/apache/kafka/clients/producer/Callback.html#onCompletion-org.apache.kafka.clients.producer.RecordMetadata-java.lang.Exception-"/>
        /// </summary>

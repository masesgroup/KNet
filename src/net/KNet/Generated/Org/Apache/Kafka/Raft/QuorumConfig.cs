...
namespace Org.Apache.Kafka.Raft
{
    ...
    public partial class QuorumConfig
    {
        ...
        /// </summary>
        public static bool DEFAULT_QUORUM_AUTO_JOIN_ENABLE { get { if (!_DEFAULT_QUORUM_AUTO_JOIN_ENABLEReady) { _DEFAULT_QUORUM_AUTO_JOIN_ENABLEContent = SGetField<bool>(LocalBridgeClazz, "DEFAULT_QUORUM_AUTO_JOIN_ENABLE"); _DEFAULT_QUORUM_AUTO_JOIN_ENABLEReady = true; } return _DEFAULT_QUORUM_AUTO_JOIN_ENABLEContent; } }
        private static bool _DEFAULT_QUORUM_AUTO_JOIN_ENABLEContent = default;
        private static bool _DEFAULT_QUORUM_AUTO_JOIN_ENABLEReady = false; // this is used because in case of generics 
        /// <summary>
        ...
        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-raft/4.2.0/org/apache/kafka/raft/QuorumConfig.html#DEFAULT_QUORUM_FETCH_MAX_BYTES"/>
        /// </summary>
        public static int DEFAULT_QUORUM_FETCH_MAX_BYTES { get { if (!_DEFAULT_QUORUM_FETCH_MAX_BYTESReady) { _DEFAULT_QUORUM_FETCH_MAX_BYTESContent = SGetField<int>(LocalBridgeClazz, "DEFAULT_QUORUM_FETCH_MAX_BYTES"); _DEFAULT_QUORUM_FETCH_MAX_BYTESReady = true; } return _DEFAULT_QUORUM_FETCH_MAX_BYTESContent; } }
        private static int _DEFAULT_QUORUM_FETCH_MAX_BYTESContent = default;
        private static bool _DEFAULT_QUORUM_FETCH_MAX_BYTESReady = false; // this is used because in case of generics 
        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-raft/4.2.0/org/apache/kafka/raft/QuorumConfig.html#DEFAULT_QUORUM_FETCH_SNAPSHOT_MAX_BYTES"/>
        /// </summary>
        public static int DEFAULT_QUORUM_FETCH_SNAPSHOT_MAX_BYTES { get { if (!_DEFAULT_QUORUM_FETCH_SNAPSHOT_MAX_BYTESReady) { _DEFAULT_QUORUM_FETCH_SNAPSHOT_MAX_BYTESContent = SGetField<int>(LocalBridgeClazz, "DEFAULT_QUORUM_FETCH_SNAPSHOT_MAX_BYTES"); _DEFAULT_QUORUM_FETCH_SNAPSHOT_MAX_BYTESReady = true; } return _DEFAULT_QUORUM_FETCH_SNAPSHOT_MAX_BYTESContent; } }
        private static int _DEFAULT_QUORUM_FETCH_SNAPSHOT_MAX_BYTESContent = default;
        private static bool _DEFAULT_QUORUM_FETCH_SNAPSHOT_MAX_BYTESReady = false; // this is used because in case of generics 
        /// <summary>
        ...
        /// </summary>
        public static Java.Lang.String QUORUM_AUTO_JOIN_ENABLE_CONFIG { get { if (!_QUORUM_AUTO_JOIN_ENABLE_CONFIGReady) { _QUORUM_AUTO_JOIN_ENABLE_CONFIGContent = SGetField<Java.Lang.String>(LocalBridgeClazz, "QUORUM_AUTO_JOIN_ENABLE_CONFIG"); _QUORUM_AUTO_JOIN_ENABLE_CONFIGReady = true; } return _QUORUM_AUTO_JOIN_ENABLE_CONFIGContent; } }
        private static Java.Lang.String _QUORUM_AUTO_JOIN_ENABLE_CONFIGContent = default;
        private static bool _QUORUM_AUTO_JOIN_ENABLE_CONFIGReady = false; // this is used because in case of generics 
        /// <summary>
        ...
        /// </summary>
        public static Java.Lang.String QUORUM_AUTO_JOIN_ENABLE_DOC { get { if (!_QUORUM_AUTO_JOIN_ENABLE_DOCReady) { _QUORUM_AUTO_JOIN_ENABLE_DOCContent = SGetField<Java.Lang.String>(LocalBridgeClazz, "QUORUM_AUTO_JOIN_ENABLE_DOC"); _QUORUM_AUTO_JOIN_ENABLE_DOCReady = true; } return _QUORUM_AUTO_JOIN_ENABLE_DOCContent; } }
        private static Java.Lang.String _QUORUM_AUTO_JOIN_ENABLE_DOCContent = default;
        private static bool _QUORUM_AUTO_JOIN_ENABLE_DOCReady = false; // this is used because in case of generics 
        /// <summary>
        ...
        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-raft/4.2.0/org/apache/kafka/raft/QuorumConfig.html#QUORUM_FETCH_MAX_BYTES_CONFIG"/>
        /// </summary>
        public static Java.Lang.String QUORUM_FETCH_MAX_BYTES_CONFIG { get { if (!_QUORUM_FETCH_MAX_BYTES_CONFIGReady) { _QUORUM_FETCH_MAX_BYTES_CONFIGContent = SGetField<Java.Lang.String>(LocalBridgeClazz, "QUORUM_FETCH_MAX_BYTES_CONFIG"); _QUORUM_FETCH_MAX_BYTES_CONFIGReady = true; } return _QUORUM_FETCH_MAX_BYTES_CONFIGContent; } }
        private static Java.Lang.String _QUORUM_FETCH_MAX_BYTES_CONFIGContent = default;
        private static bool _QUORUM_FETCH_MAX_BYTES_CONFIGReady = false; // this is used because in case of generics 
        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-raft/4.2.0/org/apache/kafka/raft/QuorumConfig.html#QUORUM_FETCH_MAX_BYTES_DOC"/>
        /// </summary>
        public static Java.Lang.String QUORUM_FETCH_MAX_BYTES_DOC { get { if (!_QUORUM_FETCH_MAX_BYTES_DOCReady) { _QUORUM_FETCH_MAX_BYTES_DOCContent = SGetField<Java.Lang.String>(LocalBridgeClazz, "QUORUM_FETCH_MAX_BYTES_DOC"); _QUORUM_FETCH_MAX_BYTES_DOCReady = true; } return _QUORUM_FETCH_MAX_BYTES_DOCContent; } }
        private static Java.Lang.String _QUORUM_FETCH_MAX_BYTES_DOCContent = default;
        private static bool _QUORUM_FETCH_MAX_BYTES_DOCReady = false; // this is used because in case of generics 
        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-raft/4.2.0/org/apache/kafka/raft/QuorumConfig.html#QUORUM_FETCH_SNAPSHOT_MAX_BYTES_CONFIG"/>
        /// </summary>
        public static Java.Lang.String QUORUM_FETCH_SNAPSHOT_MAX_BYTES_CONFIG { get { if (!_QUORUM_FETCH_SNAPSHOT_MAX_BYTES_CONFIGReady) { _QUORUM_FETCH_SNAPSHOT_MAX_BYTES_CONFIGContent = SGetField<Java.Lang.String>(LocalBridgeClazz, "QUORUM_FETCH_SNAPSHOT_MAX_BYTES_CONFIG"); _QUORUM_FETCH_SNAPSHOT_MAX_BYTES_CONFIGReady = true; } return _QUORUM_FETCH_SNAPSHOT_MAX_BYTES_CONFIGContent; } }
        private static Java.Lang.String _QUORUM_FETCH_SNAPSHOT_MAX_BYTES_CONFIGContent = default;
        private static bool _QUORUM_FETCH_SNAPSHOT_MAX_BYTES_CONFIGReady = false; // this is used because in case of generics 
        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-raft/4.2.0/org/apache/kafka/raft/QuorumConfig.html#QUORUM_FETCH_SNAPSHOT_MAX_BYTES_DOC"/>
        /// </summary>
        public static Java.Lang.String QUORUM_FETCH_SNAPSHOT_MAX_BYTES_DOC { get { if (!_QUORUM_FETCH_SNAPSHOT_MAX_BYTES_DOCReady) { _QUORUM_FETCH_SNAPSHOT_MAX_BYTES_DOCContent = SGetField<Java.Lang.String>(LocalBridgeClazz, "QUORUM_FETCH_SNAPSHOT_MAX_BYTES_DOC"); _QUORUM_FETCH_SNAPSHOT_MAX_BYTES_DOCReady = true; } return _QUORUM_FETCH_SNAPSHOT_MAX_BYTES_DOCContent; } }
        private static Java.Lang.String _QUORUM_FETCH_SNAPSHOT_MAX_BYTES_DOCContent = default;
        private static bool _QUORUM_FETCH_SNAPSHOT_MAX_BYTES_DOCReady = false; // this is used because in case of generics 
        /// <summary>
        ...
        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-raft/4.2.0/org/apache/kafka/raft/QuorumConfig.html#fetchMaxBytes()"/>
        /// </summary>
        /// <returns><see cref="int"/></returns>
        ...
        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/kafka-raft/4.2.0/org/apache/kafka/raft/QuorumConfig.html#fetchSnapshotMaxBytes()"/>
        /// </summary>
        /// <returns><see cref="int"/></returns>

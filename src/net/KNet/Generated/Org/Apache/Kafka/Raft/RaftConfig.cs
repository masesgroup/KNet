...
namespace Org.Apache.Kafka.Raft
{
    ...
    public partial class RaftConfig
    {
        ...
        /// </summary>
        public static string QUORUM_ELECTION_BACKOFF_MAX_MS_CONFIG { get { if (!_QUORUM_ELECTION_BACKOFF_MAX_MS_CONFIGReady) { _QUORUM_ELECTION_BACKOFF_MAX_MS_CONFIGContent = SGetField<string>(LocalBridgeClazz, "QUORUM_ELECTION_BACKOFF_MAX_MS_CONFIG"); _QUORUM_ELECTION_BACKOFF_MAX_MS_CONFIGReady = true; } return _QUORUM_ELECTION_BACKOFF_MAX_MS_CONFIGContent; } }
        private static string _QUORUM_ELECTION_BACKOFF_MAX_MS_CONFIGContent = default;
        ...
        /// </summary>
        public static string QUORUM_ELECTION_BACKOFF_MAX_MS_DOC { get { if (!_QUORUM_ELECTION_BACKOFF_MAX_MS_DOCReady) { _QUORUM_ELECTION_BACKOFF_MAX_MS_DOCContent = SGetField<string>(LocalBridgeClazz, "QUORUM_ELECTION_BACKOFF_MAX_MS_DOC"); _QUORUM_ELECTION_BACKOFF_MAX_MS_DOCReady = true; } return _QUORUM_ELECTION_BACKOFF_MAX_MS_DOCContent; } }
        private static string _QUORUM_ELECTION_BACKOFF_MAX_MS_DOCContent = default;
        ...
        /// </summary>
        public static string QUORUM_ELECTION_TIMEOUT_MS_CONFIG { get { if (!_QUORUM_ELECTION_TIMEOUT_MS_CONFIGReady) { _QUORUM_ELECTION_TIMEOUT_MS_CONFIGContent = SGetField<string>(LocalBridgeClazz, "QUORUM_ELECTION_TIMEOUT_MS_CONFIG"); _QUORUM_ELECTION_TIMEOUT_MS_CONFIGReady = true; } return _QUORUM_ELECTION_TIMEOUT_MS_CONFIGContent; } }
        private static string _QUORUM_ELECTION_TIMEOUT_MS_CONFIGContent = default;
        ...
        /// </summary>
        public static string QUORUM_ELECTION_TIMEOUT_MS_DOC { get { if (!_QUORUM_ELECTION_TIMEOUT_MS_DOCReady) { _QUORUM_ELECTION_TIMEOUT_MS_DOCContent = SGetField<string>(LocalBridgeClazz, "QUORUM_ELECTION_TIMEOUT_MS_DOC"); _QUORUM_ELECTION_TIMEOUT_MS_DOCReady = true; } return _QUORUM_ELECTION_TIMEOUT_MS_DOCContent; } }
        private static string _QUORUM_ELECTION_TIMEOUT_MS_DOCContent = default;
        ...
        /// </summary>
        public static string QUORUM_FETCH_TIMEOUT_MS_CONFIG { get { if (!_QUORUM_FETCH_TIMEOUT_MS_CONFIGReady) { _QUORUM_FETCH_TIMEOUT_MS_CONFIGContent = SGetField<string>(LocalBridgeClazz, "QUORUM_FETCH_TIMEOUT_MS_CONFIG"); _QUORUM_FETCH_TIMEOUT_MS_CONFIGReady = true; } return _QUORUM_FETCH_TIMEOUT_MS_CONFIGContent; } }
        private static string _QUORUM_FETCH_TIMEOUT_MS_CONFIGContent = default;
        ...
        /// </summary>
        public static string QUORUM_FETCH_TIMEOUT_MS_DOC { get { if (!_QUORUM_FETCH_TIMEOUT_MS_DOCReady) { _QUORUM_FETCH_TIMEOUT_MS_DOCContent = SGetField<string>(LocalBridgeClazz, "QUORUM_FETCH_TIMEOUT_MS_DOC"); _QUORUM_FETCH_TIMEOUT_MS_DOCReady = true; } return _QUORUM_FETCH_TIMEOUT_MS_DOCContent; } }
        private static string _QUORUM_FETCH_TIMEOUT_MS_DOCContent = default;
        ...
        /// </summary>
        public static string QUORUM_LINGER_MS_CONFIG { get { if (!_QUORUM_LINGER_MS_CONFIGReady) { _QUORUM_LINGER_MS_CONFIGContent = SGetField<string>(LocalBridgeClazz, "QUORUM_LINGER_MS_CONFIG"); _QUORUM_LINGER_MS_CONFIGReady = true; } return _QUORUM_LINGER_MS_CONFIGContent; } }
        private static string _QUORUM_LINGER_MS_CONFIGContent = default;
        ...
        /// </summary>
        public static string QUORUM_LINGER_MS_DOC { get { if (!_QUORUM_LINGER_MS_DOCReady) { _QUORUM_LINGER_MS_DOCContent = SGetField<string>(LocalBridgeClazz, "QUORUM_LINGER_MS_DOC"); _QUORUM_LINGER_MS_DOCReady = true; } return _QUORUM_LINGER_MS_DOCContent; } }
        private static string _QUORUM_LINGER_MS_DOCContent = default;
        ...
        /// </summary>
        public static string QUORUM_REQUEST_TIMEOUT_MS_CONFIG { get { if (!_QUORUM_REQUEST_TIMEOUT_MS_CONFIGReady) { _QUORUM_REQUEST_TIMEOUT_MS_CONFIGContent = SGetField<string>(LocalBridgeClazz, "QUORUM_REQUEST_TIMEOUT_MS_CONFIG"); _QUORUM_REQUEST_TIMEOUT_MS_CONFIGReady = true; } return _QUORUM_REQUEST_TIMEOUT_MS_CONFIGContent; } }
        private static string _QUORUM_REQUEST_TIMEOUT_MS_CONFIGContent = default;
        ...
        /// </summary>
        public static string QUORUM_REQUEST_TIMEOUT_MS_DOC { get { if (!_QUORUM_REQUEST_TIMEOUT_MS_DOCReady) { _QUORUM_REQUEST_TIMEOUT_MS_DOCContent = SGetField<string>(LocalBridgeClazz, "QUORUM_REQUEST_TIMEOUT_MS_DOC"); _QUORUM_REQUEST_TIMEOUT_MS_DOCReady = true; } return _QUORUM_REQUEST_TIMEOUT_MS_DOCContent; } }
        private static string _QUORUM_REQUEST_TIMEOUT_MS_DOCContent = default;
        ...
        /// </summary>
        public static string QUORUM_RETRY_BACKOFF_MS_CONFIG { get { if (!_QUORUM_RETRY_BACKOFF_MS_CONFIGReady) { _QUORUM_RETRY_BACKOFF_MS_CONFIGContent = SGetField<string>(LocalBridgeClazz, "QUORUM_RETRY_BACKOFF_MS_CONFIG"); _QUORUM_RETRY_BACKOFF_MS_CONFIGReady = true; } return _QUORUM_RETRY_BACKOFF_MS_CONFIGContent; } }
        private static string _QUORUM_RETRY_BACKOFF_MS_CONFIGContent = default;
        ...
        /// </summary>
        public static string QUORUM_RETRY_BACKOFF_MS_DOC { get { if (!_QUORUM_RETRY_BACKOFF_MS_DOCReady) { _QUORUM_RETRY_BACKOFF_MS_DOCContent = SGetField<string>(LocalBridgeClazz, "QUORUM_RETRY_BACKOFF_MS_DOC"); _QUORUM_RETRY_BACKOFF_MS_DOCReady = true; } return _QUORUM_RETRY_BACKOFF_MS_DOCContent; } }
        private static string _QUORUM_RETRY_BACKOFF_MS_DOCContent = default;
        ...
        /// </summary>
        public static string QUORUM_VOTERS_CONFIG { get { if (!_QUORUM_VOTERS_CONFIGReady) { _QUORUM_VOTERS_CONFIGContent = SGetField<string>(LocalBridgeClazz, "QUORUM_VOTERS_CONFIG"); _QUORUM_VOTERS_CONFIGReady = true; } return _QUORUM_VOTERS_CONFIGContent; } }
        private static string _QUORUM_VOTERS_CONFIGContent = default;
        ...
        /// </summary>
        public static string QUORUM_VOTERS_DOC { get { if (!_QUORUM_VOTERS_DOCReady) { _QUORUM_VOTERS_DOCContent = SGetField<string>(LocalBridgeClazz, "QUORUM_VOTERS_DOC"); _QUORUM_VOTERS_DOCReady = true; } return _QUORUM_VOTERS_DOCContent; } }
        private static string _QUORUM_VOTERS_DOCContent = default;

...
namespace Org.Apache.Kafka.Connect.Util
{
    ...
    public partial class LoggingContext
    {
        ...
        /// </summary>
        public static string CONNECTOR_CONTEXT { get { if (!_CONNECTOR_CONTEXTReady) { _CONNECTOR_CONTEXTContent = SGetField<string>(LocalBridgeClazz, "CONNECTOR_CONTEXT"); _CONNECTOR_CONTEXTReady = true; } return _CONNECTOR_CONTEXTContent; } }
        private static string _CONNECTOR_CONTEXTContent = default;

...
namespace Org.Apache.Kafka.Connect.Util
{
    ...
    /// </summary>
    public partial class ConnectorTaskId : Java.Lang.Record
    {
    ...
    public partial class ConnectorTaskId : Java.Io.ISerializable, Java.Lang.IComparable<Org.Apache.Kafka.Connect.Util.ConnectorTaskId>
    {
        #region Constructors
        /// <summary>
        /// <see href="https://www.javadoc.io/doc/org.apache.kafka/connect-runtime/4.0.0/org/apache/kafka/connect/util/ConnectorTaskId.html#%3Cinit%3E(java.lang.String,int)"/>
        /// </summary>
        /// <param name="connector"><see cref="Java.Lang.String"/></param>
        /// <param name="task"><see cref="int"/></param>
        public ConnectorTaskId(Java.Lang.String connector, int task)
            : base(connector, task)
        {
        }

...
namespace Org.Apache.Kafka.Connect.Mirror
{
    ...
    public partial class DefaultTopicFilter
    {
        ...
        /// </summary>
        public static string TOPICS_EXCLUDE_CONFIG { get { if (!_TOPICS_EXCLUDE_CONFIGReady) { _TOPICS_EXCLUDE_CONFIGContent = SGetField<string>(LocalBridgeClazz, "TOPICS_EXCLUDE_CONFIG"); _TOPICS_EXCLUDE_CONFIGReady = true; } return _TOPICS_EXCLUDE_CONFIGContent; } }
        private static string _TOPICS_EXCLUDE_CONFIGContent = default;
        ...
        /// </summary>
        public static string TOPICS_EXCLUDE_CONFIG_ALIAS { get { if (!_TOPICS_EXCLUDE_CONFIG_ALIASReady) { _TOPICS_EXCLUDE_CONFIG_ALIASContent = SGetField<string>(LocalBridgeClazz, "TOPICS_EXCLUDE_CONFIG_ALIAS"); _TOPICS_EXCLUDE_CONFIG_ALIASReady = true; } return _TOPICS_EXCLUDE_CONFIG_ALIASContent; } }
        private static string _TOPICS_EXCLUDE_CONFIG_ALIASContent = default;
        ...
        /// </summary>
        public static string TOPICS_INCLUDE_CONFIG { get { if (!_TOPICS_INCLUDE_CONFIGReady) { _TOPICS_INCLUDE_CONFIGContent = SGetField<string>(LocalBridgeClazz, "TOPICS_INCLUDE_CONFIG"); _TOPICS_INCLUDE_CONFIGReady = true; } return _TOPICS_INCLUDE_CONFIGContent; } }
        private static string _TOPICS_INCLUDE_CONFIGContent = default;
        ...
        /// </summary>
        public static string TOPICS_INCLUDE_DEFAULT { get { if (!_TOPICS_INCLUDE_DEFAULTReady) { _TOPICS_INCLUDE_DEFAULTContent = SGetField<string>(LocalBridgeClazz, "TOPICS_INCLUDE_DEFAULT"); _TOPICS_INCLUDE_DEFAULTReady = true; } return _TOPICS_INCLUDE_DEFAULTContent; } }
        private static string _TOPICS_INCLUDE_DEFAULTContent = default;

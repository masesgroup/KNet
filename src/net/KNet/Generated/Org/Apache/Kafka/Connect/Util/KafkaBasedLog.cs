...
namespace Org.Apache.Kafka.Connect.Util
{
    ...
    /// </summary>
    public partial class KafkaBasedLog : MASES.JCOBridge.C2JBridge.JVMBridgeCore<KafkaBasedLog>
    {
    ...
    public partial class KafkaBasedLog<K, V> : MASES.JCOBridge.C2JBridge.JVMBridgeCore<KafkaBasedLog<K, V>>
    {
        const string _bridgeClassName = "org.apache.kafka.connect.util.KafkaBasedLog";
        /// <summary>
        /// Internal constructor: used internally from JCOBridge

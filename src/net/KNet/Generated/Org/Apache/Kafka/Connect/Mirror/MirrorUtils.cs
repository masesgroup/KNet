...
namespace Org.Apache.Kafka.Connect.Mirror
{
    ...
    public partial class MirrorUtils
    {
        ...
        /// </summary>
        public static string OFFSET_KEY { get { if (!_OFFSET_KEYReady) { _OFFSET_KEYContent = SGetField<string>(LocalBridgeClazz, "OFFSET_KEY"); _OFFSET_KEYReady = true; } return _OFFSET_KEYContent; } }
        private static string _OFFSET_KEYContent = default;
        ...
        /// </summary>
        public static string SOURCE_CLUSTER_KEY { get { if (!_SOURCE_CLUSTER_KEYReady) { _SOURCE_CLUSTER_KEYContent = SGetField<string>(LocalBridgeClazz, "SOURCE_CLUSTER_KEY"); _SOURCE_CLUSTER_KEYReady = true; } return _SOURCE_CLUSTER_KEYContent; } }
        private static string _SOURCE_CLUSTER_KEYContent = default;

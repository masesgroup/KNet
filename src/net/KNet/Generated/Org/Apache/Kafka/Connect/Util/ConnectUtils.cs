...
namespace Org.Apache.Kafka.Connect.Util
{
    ...
    public partial class ConnectUtils
    {
        ...
        /// </summary>
        public ConnectUtils() : base(JVMBridgeBase.InitializerInstance)
        {
            InvokeInitializer();
        }
        /// <summary>
        /// HPA initializer for ConnectUtils()
        /// </summary>
        public static ConnectUtils CreatePoolableInstance()
        {
            return JVMBridgeBase.New<ConnectUtils>();
        }

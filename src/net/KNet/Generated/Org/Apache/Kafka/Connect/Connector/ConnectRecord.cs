...
namespace Org.Apache.Kafka.Connect.Connector
{
    ...
    /// </summary>
    public partial class ConnectRecord : MASES.JCOBridge.C2JBridge.JVMBridgeCore<ConnectRecord>
    {
    ...
    public partial class ConnectRecord<R> : MASES.JCOBridge.C2JBridge.JVMBridgeCore<ConnectRecord<R>> where R : Org.Apache.Kafka.Connect.Connector.ConnectRecord<R>
    {
        const string _bridgeClassName = "org.apache.kafka.connect.connector.ConnectRecord";
        /// <summary>
        /// Internal constructor: used internally from JCOBridge

...
{
    /// <summary>
    /// Listerner for Kafka StateRestoreListener. Extends <see cref="IJVMBridgeBase"/>
    /// </summary>
    ...
    /// <summary>
    /// Listerner for Kafka StateRestoreListener. Extends <see cref="CLRListener"/>, implements <see cref="IStateRestoreListener"/>
    /// </summary>

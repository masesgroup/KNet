...
public final class BatchingStateRestoreCallback implements org.mases.jcobridge.IJCListener, org.apache.kafka.streams.processor.BatchingStateRestoreCallback {
    ...
    int _restoreAllIndex = 0;
    //@Override
    public void restoreAll(java.util.Collection arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_restoreAllIndex <= 0) _restoreAllIndex = getEventIndex("restoreAll");
        raiseEvent(_restoreAllIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _restoreIndex = 0;
    //@Override
    public void restore(byte[] arg0, byte[] arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_restoreIndex <= 0) _restoreIndex = getEventIndex("restore");
        raiseEvent(_restoreIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) org.apache.kafka.streams.processor.BatchingStateRestoreCallback.super.restore(arg0, arg1);
    }

    //@Override
    public void restoreDefault(byte[] arg0, byte[] arg1) {
        org.apache.kafka.streams.processor.BatchingStateRestoreCallback.super.restore(arg0, arg1);
    }

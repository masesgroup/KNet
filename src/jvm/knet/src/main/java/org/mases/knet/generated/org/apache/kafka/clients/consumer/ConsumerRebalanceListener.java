...
public final class ConsumerRebalanceListener implements org.mases.jcobridge.IJCListener, org.apache.kafka.clients.consumer.ConsumerRebalanceListener {
    ...
    int _onPartitionsAssignedIndex = 0;
    //@Override
    public void onPartitionsAssigned(java.util.Collection arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPartitionsAssignedIndex <= 0) _onPartitionsAssignedIndex = getEventIndex("onPartitionsAssigned");
        raiseEvent(_onPartitionsAssignedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onPartitionsRevokedIndex = 0;
    //@Override
    public void onPartitionsRevoked(java.util.Collection arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPartitionsRevokedIndex <= 0) _onPartitionsRevokedIndex = getEventIndex("onPartitionsRevoked");
        raiseEvent(_onPartitionsRevokedIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onPartitionsLostIndex = 0;
    //@Override
    public void onPartitionsLost(java.util.Collection arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onPartitionsLostIndex <= 0) _onPartitionsLostIndex = getEventIndex("onPartitionsLost");
        raiseEvent(_onPartitionsLostIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) org.apache.kafka.clients.consumer.ConsumerRebalanceListener.super.onPartitionsLost(arg0);
    }

    //@Override
    public void onPartitionsLostDefault(java.util.Collection arg0) {
        org.apache.kafka.clients.consumer.ConsumerRebalanceListener.super.onPartitionsLost(arg0);
    }

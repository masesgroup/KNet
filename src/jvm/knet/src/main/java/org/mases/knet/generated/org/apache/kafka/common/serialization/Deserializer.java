...
public final class Deserializer implements org.mases.jcobridge.IJCListener, org.apache.kafka.common.serialization.Deserializer {
    ...
    int _deserializeIndex = 0;
    //@Override
    public java.lang.Object deserialize(java.lang.String arg0, byte[] arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_deserializeIndex <= 0) _deserializeIndex = getEventIndex("deserialize");
        raiseEvent(_deserializeIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (java.lang.Object)retVal;
    }
    int _deserialize3Index = 0;
    //@Override
    public java.lang.Object deserialize(java.lang.String arg0, org.apache.kafka.common.header.Headers arg1, byte[] arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_deserialize3Index <= 0) _deserialize3Index = getEventIndex("deserialize3");
        raiseEvent(_deserialize3Index, eventDataExchange, arg0, arg1, arg2); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = org.apache.kafka.common.serialization.Deserializer.super.deserialize(arg0, arg1, arg2); else retVal = eventDataExchange.getReturnData(); return (java.lang.Object)retVal;
    }
    ...
    public java.lang.Object deserialize(java.lang.String arg0, org.apache.kafka.common.header.Headers arg1, java.nio.ByteBuffer arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_deserialize3_2Index <= 0) _deserialize3_2Index = getEventIndex("deserialize3_2");
        raiseEvent(_deserialize3_2Index, eventDataExchange, arg0, arg1, arg2); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = org.apache.kafka.common.serialization.Deserializer.super.deserialize(arg0, arg1, arg2); else retVal = eventDataExchange.getReturnData(); return (java.lang.Object)retVal;
    }
    ...
    public void close() {
        ...
        raiseEvent(_closeIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) org.apache.kafka.common.serialization.Deserializer.super.close();
    }
    ...
    public void configure(java.util.Map arg0, boolean arg1) {
        ...
        raiseEvent(_configureIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) org.apache.kafka.common.serialization.Deserializer.super.configure(arg0, arg1);
    }

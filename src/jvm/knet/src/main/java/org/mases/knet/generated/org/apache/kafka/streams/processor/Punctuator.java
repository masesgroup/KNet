...
public final class Punctuator implements org.mases.jcobridge.IJCListener, org.apache.kafka.streams.processor.Punctuator {
    ...
    int _punctuateIndex = 0;
    //@Override
    public void punctuate(long arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_punctuateIndex <= 0) _punctuateIndex = getEventIndex("punctuate");
        raiseEvent(_punctuateIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }

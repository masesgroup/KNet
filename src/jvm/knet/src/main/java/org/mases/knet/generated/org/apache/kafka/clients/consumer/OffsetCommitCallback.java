...
public final class OffsetCommitCallback implements org.mases.jcobridge.IJCListener, org.apache.kafka.clients.consumer.OffsetCommitCallback {
    ...
    int _onCompleteIndex = 0;
    //@Override
    public void onComplete(java.util.Map arg0, java.lang.Exception arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onCompleteIndex <= 0) _onCompleteIndex = getEventIndex("onComplete");
        raiseEvent(_onCompleteIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }

...
public final class FixedKeyProcessor implements org.mases.jcobridge.IJCListener, org.apache.kafka.streams.processor.api.FixedKeyProcessor {
    ...
    public void process(org.apache.kafka.streams.processor.api.FixedKeyRecord arg0) {
        ...
        if (_processIndex <= 0) _processIndex = getEventIndex("process");
        raiseEvent(_processIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _closeIndex = 0;
    //@Override
    public void close() {
        ...
        raiseEvent(_closeIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) org.apache.kafka.streams.processor.api.FixedKeyProcessor.super.close();
    }

    //@Override
    public void closeDefault() {
        org.apache.kafka.streams.processor.api.FixedKeyProcessor.super.close();
    }
    int _initIndex = 0;
    //@Override
    public void init(org.apache.kafka.streams.processor.api.FixedKeyProcessorContext arg0) {
        ...
        raiseEvent(_initIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) org.apache.kafka.streams.processor.api.FixedKeyProcessor.super.init(arg0);
    }

    //@Override
    public void initDefault(org.apache.kafka.streams.processor.api.FixedKeyProcessorContext arg0) {
        org.apache.kafka.streams.processor.api.FixedKeyProcessor.super.init(arg0);
    }

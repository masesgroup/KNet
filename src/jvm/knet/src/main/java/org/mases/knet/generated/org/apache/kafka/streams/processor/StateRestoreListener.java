...
public final class StateRestoreListener implements org.mases.jcobridge.IJCListener, org.apache.kafka.streams.processor.StateRestoreListener {
    ...
    public void onBatchRestored(org.apache.kafka.common.TopicPartition arg0, java.lang.String arg1, long arg2, long arg3) {
        ...
        if (_onBatchRestoredIndex <= 0) _onBatchRestoredIndex = getEventIndex("onBatchRestored");
        raiseEvent(_onBatchRestoredIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onRestoreEndIndex = 0;
    //@Override
    public void onRestoreEnd(org.apache.kafka.common.TopicPartition arg0, java.lang.String arg1, long arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onRestoreEndIndex <= 0) _onRestoreEndIndex = getEventIndex("onRestoreEnd");
        raiseEvent(_onRestoreEndIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onRestoreStartIndex = 0;
    //@Override
    public void onRestoreStart(org.apache.kafka.common.TopicPartition arg0, java.lang.String arg1, long arg2, long arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onRestoreStartIndex <= 0) _onRestoreStartIndex = getEventIndex("onRestoreStart");
        raiseEvent(_onRestoreStartIndex, eventDataExchange, arg0, arg1, arg2, arg3); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _onRestoreSuspendedIndex = 0;
    //@Override
    public void onRestoreSuspended(org.apache.kafka.common.TopicPartition arg0, java.lang.String arg1, long arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onRestoreSuspendedIndex <= 0) _onRestoreSuspendedIndex = getEventIndex("onRestoreSuspended");
        raiseEvent(_onRestoreSuspendedIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) org.apache.kafka.streams.processor.StateRestoreListener.super.onRestoreSuspended(arg0, arg1, arg2);
    }

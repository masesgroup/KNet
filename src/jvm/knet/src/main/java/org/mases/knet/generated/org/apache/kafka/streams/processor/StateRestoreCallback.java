...
public final class StateRestoreCallback implements org.mases.jcobridge.IJCListener, org.apache.kafka.streams.processor.StateRestoreCallback {
    ...
    public void restore(byte[] arg0, byte[] arg1) {
        ...
        raiseEvent(_restoreIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }

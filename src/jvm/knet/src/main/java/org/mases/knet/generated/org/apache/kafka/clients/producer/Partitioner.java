...
public final class Partitioner implements org.mases.jcobridge.IJCListener, org.apache.kafka.clients.producer.Partitioner {
    ...
    int _onNewBatchIndex = 0;
    //@Override
    public void onNewBatch(java.lang.String arg0, org.apache.kafka.common.Cluster arg1, int arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_onNewBatchIndex <= 0) _onNewBatchIndex = getEventIndex("onNewBatch");
        raiseEvent(_onNewBatchIndex, eventDataExchange, arg0, arg1, arg2); if (!eventDataExchange.getHasOverride()) org.apache.kafka.clients.producer.Partitioner.super.onNewBatch(arg0, arg1, arg2);
    }

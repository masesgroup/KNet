...
public final class FeatureLevelListener implements org.mases.jcobridge.IJCListener, org.apache.kafka.metadata.FeatureLevelListener {
    ...
    public void handle(java.lang.String arg0, short arg1) {
        ...
        if (_handleIndex <= 0) _handleIndex = getEventIndex("handle");
        raiseEvent(_handleIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }

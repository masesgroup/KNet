...
public final class Serializer implements org.mases.jcobridge.IJCListener, org.apache.kafka.common.serialization.Serializer {
    ...
    int _serializeIndex = 0;
    //@Override
    public byte[] serialize(java.lang.String arg0, java.lang.Object arg1) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_serializeIndex <= 0) _serializeIndex = getEventIndex("serialize");
        raiseEvent(_serializeIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM"); Object retVal = eventDataExchange.getReturnData(); return (byte[])retVal;
    }
    int _serialize3Index = 0;
    //@Override
    public byte[] serialize(java.lang.String arg0, org.apache.kafka.common.header.Headers arg1, java.lang.Object arg2) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_serialize3Index <= 0) _serialize3Index = getEventIndex("serialize3");
        raiseEvent(_serialize3Index, eventDataExchange, arg0, arg1, arg2); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = org.apache.kafka.common.serialization.Serializer.super.serialize(arg0, arg1, arg2); else retVal = eventDataExchange.getReturnData(); return (byte[])retVal;
    }
    ...
    public void close() {
        ...
        raiseEvent(_closeIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) org.apache.kafka.common.serialization.Serializer.super.close();
    }
    ...
    public void configure(java.util.Map arg0, boolean arg1) {
        ...
        raiseEvent(_configureIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) org.apache.kafka.common.serialization.Serializer.super.configure(arg0, arg1);
    }

...
public final class StreamPartitioner implements org.mases.jcobridge.IJCListener, org.apache.kafka.streams.processor.StreamPartitioner {
    ...
    int _partitionsIndex = 0;
    //@Override
    public java.util.Optional partitions(java.lang.String arg0, java.lang.Object arg1, java.lang.Object arg2, int arg3) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_partitionsIndex <= 0) _partitionsIndex = getEventIndex("partitions");
        raiseEvent(_partitionsIndex, eventDataExchange, arg0, arg1, arg2, arg3); Object retVal; if (!eventDataExchange.getHasOverride()) retVal = org.apache.kafka.streams.processor.StreamPartitioner.super.partitions(arg0, arg1, arg2, arg3); else retVal = eventDataExchange.getReturnData(); return (java.util.Optional)retVal;
    }

...
public final class RaftClient_Listener implements org.mases.jcobridge.IJCListener, org.apache.kafka.raft.RaftClient.Listener {
    ...
    public void handleLoadSnapshot(org.apache.kafka.snapshot.SnapshotReader arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_handleLoadSnapshotIndex <= 0) _handleLoadSnapshotIndex = getEventIndex("handleLoadSnapshot");
        raiseEvent(_handleLoadSnapshotIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }
    int _beginShutdownIndex = 0;
    //@Override
    public void beginShutdown() {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_beginShutdownIndex <= 0) _beginShutdownIndex = getEventIndex("beginShutdown");
        raiseEvent(_beginShutdownIndex, eventDataExchange); if (!eventDataExchange.getHasOverride()) org.apache.kafka.raft.RaftClient.Listener.super.beginShutdown();
    }
    ...
    int _handleLeaderChangeIndex = 0;
    //@Override
    public void handleLeaderChange(org.apache.kafka.raft.LeaderAndEpoch arg0) {
        org.mases.jnet.developed.JNetEventResult eventDataExchange = new org.mases.jnet.developed.JNetEventResult();
        if (_handleLeaderChangeIndex <= 0) _handleLeaderChangeIndex = getEventIndex("handleLeaderChange");
        raiseEvent(_handleLeaderChangeIndex, eventDataExchange, arg0); if (!eventDataExchange.getHasOverride()) org.apache.kafka.raft.RaftClient.Listener.super.handleLeaderChange(arg0);
    }

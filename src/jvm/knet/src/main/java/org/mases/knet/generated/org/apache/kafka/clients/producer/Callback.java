...
public final class Callback implements org.mases.jcobridge.IJCListener, org.apache.kafka.clients.producer.Callback {
    ...
    public void onCompletion(org.apache.kafka.clients.producer.RecordMetadata arg0, java.lang.Exception arg1) {
        ...
        raiseEvent(_onCompletionIndex, eventDataExchange, arg0, arg1); if (!eventDataExchange.getHasOverride()) throw new UnsupportedOperationException("The method shall be implemented in .NET side since does not have a default implementation within the JVM");
    }

        ...
        static void Main(string[] args)
        {
            try
            {
                ...
                if (ProduceOnly)
                {
                    ...
                    Console.WriteLine($"KNet       microseconds - Avg Filtered {kNetProduceTimes.FilterMinMax().Average():####.##} stdev Filtered {kNetProduceTimes.FilterMinMax().StandardDeviation():####.##} CV Filtered {100 * kNetProduceTimes.FilterMinMax().StandardDeviation() / kNetProduceTimes.FilterMinMax().Average():####.##} %");
                    ...
                    Console.WriteLine($"Confluent  microseconds - Avg Filtered {confluentProduceTimes.FilterMinMax().Average():####.##} stdev Filtered {confluentProduceTimes.FilterMinMax().StandardDeviation():####.##} CV Filtered {100 * confluentProduceTimes.FilterMinMax().StandardDeviation() / confluentProduceTimes.FilterMinMax().Average():####.##} %");
                    ...
                    Console.WriteLine($"KNet/Confluent ratio(%) - Avg Filtered {100 * (double)kNetProduceTimes.FilterMinMax().Average() / confluentProduceTimes.FilterMinMax().Average():####.##} stdev Filtered {100 * (double)kNetProduceTimes.FilterMinMax().StandardDeviation() / confluentProduceTimes.FilterMinMax().StandardDeviation():####.##} CV Filtered {100 * kNetProduceTimes.FilterMinMax().CoefficientOfVariation() / confluentProduceTimes.FilterMinMax().CoefficientOfVariation():####.##}");
                }
                else
                {
                    Console.WriteLine("Produce");
                    ...
                    Console.WriteLine($"KNet       microseconds - Avg Filtered {kNetConsumeTimes.FilterMinMax().Average():####.##} stdev Filtered {kNetConsumeTimes.FilterMinMax().StandardDeviation():####.##} CV Filtered {100 * kNetConsumeTimes.FilterMinMax().CoefficientOfVariation():####.##} %");
                    ...
                    Console.WriteLine($"Confluent  microseconds - Avg Filtered {confluentConsumeTimes.FilterMinMax().Average():####.##} stdev Filtered {confluentConsumeTimes.FilterMinMax().StandardDeviation():####.##} CV Filtered {100 * confluentConsumeTimes.FilterMinMax().CoefficientOfVariation():####.##} %");
                    ...
                    Console.WriteLine($"KNet/Confluent ratio(%) - Avg Filtered {100 * (double)kNetConsumeTimes.FilterMinMax().Average() / confluentConsumeTimes.FilterMinMax().Average():####.##} stdev Filtered {100 * (double)kNetConsumeTimes.FilterMinMax().StandardDeviation() / confluentConsumeTimes.FilterMinMax().StandardDeviation():####.##} CV Filtered {100 * kNetConsumeTimes.FilterMinMax().CoefficientOfVariation() / confluentConsumeTimes.FilterMinMax().CoefficientOfVariation():####.##}");
                }
